...
const items = [
  ...
  { href: "/tenant/pay", label: "Pay", icon: PayIcon },
  { href: "/tenant/rewards", label: "Rewards", icon: RewardsIcon },
  { href: "/tenant/profile", label: "Profile", icon: ProfileIcon },
];
...
// tiny util colocated to avoid a shared utils import for now
